          ...
          <div>
            ...
            <address className="not-italic space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919560111997" className="text-gray-400 hover:text-amber-500 transition-colors text-sm font-light">+91 9696444343</a>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-4 h-4 text-amber-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:concierge@aparajit.com" className="text-gray-400 hover:text-amber-500 transition-colors text-sm font-light">inquiries@aparajitgroup.com</a>
              </div>
            </address>
          </div>
        </div>
